...
<a class="nav-link text-light" href="{{ route('welcome') }}" >LogOut <span class="sr-only">(current)</span></a>
</li>
<li class="nav-item">
...
<img src="https://img.freepik.com/free-vector/cute-boy-standing-position-showing-thumb_96037-450.jpg?w=2000" class="w-50 rounded-circle">
</div>
